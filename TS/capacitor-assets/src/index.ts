...
export function runProgram(ctx: Context): void {
  ...
  program
    ...
    .option('--pwaIconsPath <path>', 'Destination directory for generated PWA icons and splashes (relative to web root). Defaults to assets/icons')
    .option('--pwaOutRoot <dir>', 'Optional root folder to physically write PWA assets into (e.g., www). Not included in manifest URLs.')
    .option(
