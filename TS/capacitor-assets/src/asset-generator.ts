...
export interface AssetGeneratorOptions {
  ...
  // Destination directory for generated PWA icons and splashes (relative to the PWA root).
  // Defaults to "assets/icons" when not provided.
  pwaIconsPath?: string;
  // Optional root directory to write PWA assets to (e.g., 'www').
  // Not included in manifest icon URLs.
  pwaOutRoot?: string;
